...
@include('partials._messages')    
    <div class="container focusSet">
        <div class="area px-1 py-5 w-100">
            <h2 class="mx-3 pb-2 text-center">Add a new Client</h2>
                ...
                @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 pl-0">
                            <input name="fname" type="text" class="form-control input-back-color form-control-lg" id="colFormLabelLg" placeholder="" required data-parsley-pattern="^[a-zA-Z][a-zA-Z ]*$" data-parsley-trigger="keyup" >
                        </div>
                    </div>
                    <div class="form-group row">
