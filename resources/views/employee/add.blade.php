...
@include('partials._messages')
    <div class="container focusSet">
        <div class="area px-1 py-5 w-100">
            <h2 class="mx-3 pb-2 text-center">Add a new employee</h2>
            
            <div class="form-aera border ml-3">
                <form class="px-4 py-4" method="post" action="{{route('employee.store')}}" id="add-employee-form" data-parsley-validate>
                    @csrf   
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-check ml-1">
                                <input class="form-check-input input-back-color font mr-4 mt-2 checkbox-width-height" value="yes" type="radio" id="manual-hand" name="manual_hand" required data-parsley-trigger="keyup">
                        ...
                        <div class="col-sm-5">
                            <div class="form-check">
                                <input class="form-check-input input-back-color font mr-4 mt-2 checkbox-width-height" type="radio" id="gridCheck1" name="manual_hand" value="no" required data-parsley-trigger="keyup">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-check ml-1">
                                <input class="form-check-input input-back-color font mr-4 mt-2 checkbox-width-height" type="radio" id="banned-yes" name="banned" value="yes" required data-parsley-trigger="keyup">
                                <label class="form-check-label font  ml-4 mt-2" for="gridCheck1">
                                    Yes
                                </label>
                            </div>
                        ...
                        <div class="col-sm-5">
                            <div class="form-check">
                                <input class="form-check-input input-back-color font mr-4 mt-2 checkbox-width-height" type="radio" id="banned-no" name="banned" value="no" required data-parsley-trigger="keyup">
                                <label class="form-check-label font  ml-4 mt-2" for="gridCheck1">
                                    No
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-check ml-1">
                                <input class="form-check-input input-back-color font mr-4 mt-2 checkbox-width-height" type="radio" id="full-available" name="full_available"  value="yes" required data-parsley-trigger="keyup">
                                <label class="form-check-label  font ml-4 mt-2" for="gridCheck1">
                                    Yes
                                </label>
                            </div>
                        ...
                        <div class="col-sm-5">
                            <div class="form-check">
                                <input class="form-check-input input-back-color font mr-4 mt-2 checkbox-width-height" type="radio" id="no-available" name="full_available" value="no" required data-parsley-trigger="keyup">
                                <label class="form-check-label font  ml-4 mt-2" for="gridCheck1" >
                                    No
                                </label>
                            </div>
